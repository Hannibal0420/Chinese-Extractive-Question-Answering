...
#        except:
#            print("Fail to download dataset online")
#            try:
        raw_datasets = datasets.load_from_disk(args.dataset_name, args.dataset_config_name)
#            except:
#                print("Fail to download dataset locally")
    else:
        data_files = {}
